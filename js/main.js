...
$('.main-slick-two').slick({
    ...
    slidesToScroll: 1,
    swipeToSlide: true,
    prevArrow: '<button class="slick-prev-two slick-arrow-two" aria-label="Previous" type="button"><img src="img/ic_left_arrow.svg" class="img-fluid"/></button>',
    nextArrow: '<button class="slick-next-two slick-arrow-two" aria-label="Next" type="button"><img src="img/ic_right_arrow.svg" class="img-fluid"/></button>',
    responsive: [{
    breakpoint: 1024, settings: {
        slidesToShow: 6, slidesToScroll: 1, infinite: true, dots: true
    }
